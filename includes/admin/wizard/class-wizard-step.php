...
namespace POC\Foundation\Admin\Wizard;
...
class Wizard_Step
{
	...
	public static function get_step_license()
	{
		$content = array();
	...
	public static function get_step_plugins()
	{
		...
		foreach ( $plugin_manager->get_required_plugins() as $plugin ) {
	...
	public static function get_step_campaign()
	{
		$content = array();
	...
	public static function get_step_config()
	{
		$content = array();
