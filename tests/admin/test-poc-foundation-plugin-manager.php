...
class Test_Class_POC_Foundation_Plugin_Manager extends \WP_UnitTestCase
{
	public $instance;
	...
	public function setUp() {
		...
		$this->instance = new POC_Foundation_Plugin_Manager();
	}
	...
	{
		$mock = m::mock( POC_Foundation_Plugin_Manager::class )->makePartial()->shouldAllowMockingProtectedMethods();
	...
	{
		return m::mock( POC_Foundation_Plugin_Manager::class )->makePartial()->shouldAllowMockingProtectedMethods();
	}
