...
class Test_Class_AJAX extends \WP_Ajax_UnitTestCase
{
	...
	{
		$license_mock = m::mock( License::class );
		...
		$ajax_mock = m::mock( AJAX::class )->makePartial()->shouldAllowMockingProtectedMethods();
	...
	{
		$plugin_manager_mock = m::mock( Plugin_Manager::class )->makePartial()->shouldAllowMockingProtectedMethods();
	...
	public function test_save_config()
	{
		...
		$mock = m::mock( AJAX::class )->makePartial()->shouldAllowMockingProtectedMethods();
	...
	public function test_check_elementor_pro_status()
	{
		...
		$elementor_pro_mock = m::mock( Elementor_Pro::class )->makePartial()->shouldAllowMockingProtectedMethods();
